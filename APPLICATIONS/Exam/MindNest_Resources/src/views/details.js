import { getTipsById, removeTip } from '../data/mindnest.js';
...
export async function detailsView(ctx) {
    ...
    const tip = await getTipsById(id);
    ...
    async function onDelete() {
        const choice = confirm(`Are you sure you want to delete this ${tip.title}?`);

        if (choice) {
            await removeTip(tip._id);
